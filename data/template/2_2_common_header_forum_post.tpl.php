...
0
|| checktplrefresh('./template/yunzhan_saiche/common/header.htm', './template/yunzhan_saiche/common/header_common.htm', 1525328895, '2', './data/template/2_2_common_header_forum_post.tpl.php', './template/yunzhan_saiche', 'common/header_forum_post')
;?>
