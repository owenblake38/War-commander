...
body {
background:#242720 url(template/yunzhan_saiche/style/img/bgf.jpg) top center no-repeat;
        ...
        <div id="boxID"><!--焦点图盒子-->
            ...
            <div class="pic"><!--内容列表(li数目可随意增减)-->
                <ul>
                    ...
                    <li><a href="#"><img style="width:760px; height:405px;" src="/template/yunzhan_saiche/style/lun/4.jpg" thumb="" alt="标题4" text="详细描述4" /></a></li>
                    <li><a href="#"><img style="width:760px; height:405px;" src="/template/yunzhan_saiche/style/lun/5.jpg" thumb="" alt="标题5" text="详细描述5" /></a></li>
                </ul>
            </div>
        </div>
